...
public class ChatController {
    ...
    public void enterUser(@Payload ChatMessage chat, SimpMessageHeaderAccessor headerAccessor) {
        ...
        chat.setContent(chat.getSender() + " 님 입장!!");
        template.convertAndSend("/topic/chat/room/" + chat.getRoomId(), chat);
    ...
    public void webSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (username != null) {
            ...
            ChatMessage chat = ChatMessage.builder()
                    ...
                    .sender(username)
                    .content(username + " 님 퇴장!!")
                    .build();

            template.convertAndSend("/topic/chat/room/" + roomId, chat);
        }
    }
